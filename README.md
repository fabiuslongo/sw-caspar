...
In such case, together with the evaluation of *(lemma_in_syn(X, "give.v.19")*, the ActiveBelief *eval_sem(T, "Hypertensive")* will invoke the reasoner pellet and check for membership
